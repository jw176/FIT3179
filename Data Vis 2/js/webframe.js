    ...
    params: [
        {
            name: "limit",
            value: 0.6,
            bind: { input: "range", min: 0.1, max: 0.6, step: 0.01 },
        },
    ],
    layer: [
        {
            data: {
                url: "data/webframe_data.json",
            },
            mark: {
                type: "point",
                size: 100,
                ...
                values: [
                    {
                        x: 0.2,
                        y: 0.55,
                        text: "Webframes that more developers want to use than are currently using it",
                    },
                    {
                        x: 0.45,
                        y: 0.05,
                        text: "Webframes that less developers want to use than are currently using it",
                    },
                ],
            },
            mark: {
...
vegaEmbed("#webframe_vis", spec3, { mode: "vega-lite" })
    .then(console.log)
    .catch(console.warn);
